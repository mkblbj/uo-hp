...
<template>
  <section class="performance-badges" aria-label="販売実績ハイライト">
    <div class="performance-badges__top">
      <AwardBadge
        title="2021年売上 1億円"
        subtitle="ショップ開設2年後から"
        bg-color="#f3e3ac"
        :icon-path="laurelIconPath"
      />
    </div>
    <div class="performance-badges__bottom">
      <AwardBadge
        title="4.59（16,755件）"
        subtitle="口コミ総合評価"
        bg-color="#f3e3ac"
      ...
      <AwardBadge
        title="売上ランク 31位獲得"
        subtitle="楽天市場全ショップ内で"
        bg-color="#f3e3ac"
        :icon-path="laurelIconPath"
      />
    </div>
    <ul class="performance-badges__notes">
      <li>
        口コミ総合評価と口コミ件数は、楽天市場出店店舗の公開情報をもとにした2026年3月31日時点の数値です。
      </li>
      <li>
...
.performance-badges__notes li {
  color: #78716c;
  font-size: 0.88rem;
  line-height: 1.65;
}

.performance-badges__notes li::before {
  content: "※ ";
  color: #8e6f40;
  font-weight: 700;
}
